...
public class StockWatcher implements EntryPoint {
	...
	private void loadStockWatcher() {
		...
		Timer refreshTimer = new Timer() {
			...
			private void updateTable(StockPrice price) {
				...
				// Populate the Price and Changes fields with new data.
	...
	private void addStock() {
		...
		// Don't add the stock if its's already in the table
	...
	private void removeStock(final String symbol) {
		stockService.removeStock(symbol, new AsyncCallback<Void>() {
			...
			public void onSuccess(Void ignore) {
				undisplayedStock(symbol);
			}
		});
	}
	
	private void undisplayedStock(String symbol) {
